...
public class FetchOpenID extends HttpClient {
    private static final String SEND_MESSAGE = "https://api.weixin.qq.com/cgi-bin/user/get?access_token=%s&next_openid=%s";

    public FetchOpenID(String accessToken) {
