...
public class MerchantInfo {
    public static void main(String[] args) throws Exception {
        String statement = "com.qimpay.database.mapping.merchantInfo.getMerchantInfoByAppId";
    ...
    public static List<MerchantInfo> getAllMerchantInfo() {
        String statement = "com.qimpay.database.mapping.merchantInfo.getAllMerchantInfo";
        return Database.Instance().selectList(statement);
    }

    public static MerchantInfo getMerchantgzhById(long id) {
        String statement = "com.qimpay.database.mapping.merchantInfo.getMerchantgzhById";
