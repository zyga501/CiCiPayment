...
<div>
        <div id="contactlist" >
            ...
            <th  data-checkbox="true" ><th  data-field="index" data-formatter="indexFormatter" >序号</th>
                <th  data-field="name"  >商家</th><th  data-field="tradeNo"  >订单</th>
            <th  data-field="tradeAmount">交易额</th><th  data-field="tradeTime">时间</th>
            <th  data-field="tradeType"  data-formatter="typeFormatter" >支付类型</th><th  data-field="paid">是否代付过</th></tr></thead>
            </table>
        </div>
      ...
      //  $.get('< %=request.getContextPath()%>/c!contactList', function(data) {
           // data=JSON.parse(data);
            ...
            $("#ctable").bootstrapTable({
                ...
                url: "<%=request.getContextPath()%>/User!fetchPayorderList", //获取数据的Servlet地址
